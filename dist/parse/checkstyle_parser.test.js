...
describe("parseCheckstyle()", () => {
    it("maps checkstyle 8.0 violations properly", () => {
        ...
        const violations = checkstyle_parser_1.parseCheckstyle(checkstyle, root);
    ...
    it("log warn for untested checkstyle version", () => {
        ...
        checkstyle_parser_1.parseCheckstyle(checkstyle, root);
    ...
    it("parses checkstyle 8.0 without any violations", () => {
        ...
        expect(checkstyle_parser_1.parseCheckstyle(checkstyle, root)).toHaveLength(0);
    });
    it("parses checkstyle 8.0 without any violations", () => {
        const root = "/root/";
        const checkstyle = {
